...
pub(crate) fn write_ordered_fastq_offset(score_vec: &[(i32,usize)], outfolder: &String,id_map: &FxHashMap<i32,String>,fastq: &str, num_chunks: usize, create: bool, step: usize, rem: usize ){
    //writes the fastq file
    if create {
        let _ = fs::create_dir_all(PathBuf::from(outfolder).join("clustering"));
    }
...
pub(crate) fn write_output(outfolder: String, clusters: &Cluster_ID_Map, fastq: String, id_map: FxHashMap<i32,String>, n: usize, no_fastq: bool, memory_restrict: bool, num_part: usize, num_chunks: usize){
